        ...
        <div class="row submenu-row">
            <div class="col-lg-7 col-sm-12">
                <ul class="submenu_holder">
                    ...
                    <li><a class="active" href="{{route('content_document')}}">Documents</a></li>
                </ul>
            </div>
            <div class="col-lg-5 col-sm-12">
                <div class="right-submenu-holder">
                    <button><i class="fas fa-sun"></i></button>
                    <form  method="get" action="{{route('content_document')}}" class="col-sm-auto" onsubmit="return callSearchHandler()">
                        <label for="search">
            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    ...
                    <div style="text-align: left">
                        ...
                        <a href="{{route('content_document')}}" class="filter_button"> Clear Filters</a>
                    </div>
                ...
                <div class="col-lg-9">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-sm-12">
                            <a class="media-href" title="{{$document->title}}" href="">
...
<script>
    ...
    function callSearchHandler(){
        ...
        str = arr.join('&');
        console.log(str);
        window.location.replace('{{route('content_document')}}?'+str)
        return false;
    }
</script>
