        ...
        <div class="row ">
            ...
            <div class="col-lg-5">
                <div class="about-tai-image  small-mb__30 tablet-mb__30">
                    <img src="{{ asset('main/images/hero/banner6.jpg')}}" class="img-fluid" alt="About Images">
                </div>
            </div>
...
<div class="church-about-area  section-space--ptb_120">
    <div class="container">
        <div class="row ">
            ...
            <div class="col-lg-5">
                <div class="about-tai-image  small-mb__30 tablet-mb__30">
                    <img src="{{ asset('main/images/hero/banner8.jpg')}}" class="img-fluid" alt="About Images">
                </div>
            </div>
            <div class="col-lg-12 mt-2">
                <div class="about-tai-content">
