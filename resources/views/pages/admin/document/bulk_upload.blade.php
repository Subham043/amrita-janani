                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="live-preview">
                            <form id="countryForm" method="post" action="{{route('document_bulk_upload_store')}}" enctype="multipart/form-data">
                            @csrf
                            <div class="row gy-4">
...
@include('pages.admin.document.tutorial_modal')
  ...
  .addField('#upload', [
    {
        ...
        errorMessage: 'Please select atleast one upload pdf',
    },
    {
        validator: (value, fields) => {
        ...
        errorMessage: 'Maximum 20 pdfs are allowed',
    },
    {
        validator: (value, fields) => {
        if (pond.getFiles().length > 0) {
        ...
        errorMessage: 'Please select a valid upload pdf',
    },
  ])
  .onSuccess(async (event) => {
    ...
    const errorToast = (message) =>{
      ...
      try {
        ...
        const response = await axios.post('{{route('document_bulk_upload_store')}}', formData)
