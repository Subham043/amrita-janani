                        ...
                        <div id="customerList">
                            <div class="row g-4 mb-3">
                                ...
                                <div class="col-sm row mt-4" style="justify-content: flex-end">
                                    <form  method="get" action="{{route('document_view_access')}}" class="col-sm-auto" onsubmit="return callSearchHandler()">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex gap-2">
                                                    <div class="edit">
                                                        <a href="{{route('document_display_access', $item->id)}}" class="btn btn-sm btn-info edit-item-btn">View</a>
                                                    </div>
                                                    @if($item->User->userType == 2)
                                                    <div class="edit">
                                                    ...
                                                    @if($item->status == 1)
                                                    <div class="edit">
                                                        <a href="{{route('document_toggle_access', $item->id)}}" class="btn btn-sm btn-warning edit-item-btn">Revoke Access</a>
                                                    </div>
                                                    @else
                                                    <div class="edit">
                                                        <a href="{{route('document_toggle_access', $item->id)}}" class="btn btn-sm btn-warning edit-item-btn">Grant Access</a>
                                                    </div>
                                                    @endif
                                                    @endif
                                                    <div class="remove">
                                                        <button class="btn btn-sm btn-danger remove-item-btn" onclick="deleteHandler('{{route('document_delete_access', $item->id)}}')">Remove</button>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
...
<script>
    function callSearchHandler(){
        ...
        str = arr.join('&');
        window.location.replace('{{route('document_view_access')}}?'+str)
        return false;
    }
</script>
