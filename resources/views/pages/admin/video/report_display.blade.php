                        ...
                        <div class="row g-4 mb-3">
                            ...
                            <div class="col-sm">
                                <div class="d-flex justify-content-sm-end">
                                    <form action="{{route('video_toggle_report', $country->id)}}" method="get" style="margin-right:10px;">
                                    ...
                                    <button onclick="deleteHandler('{{route('video_delete_report', $country->id)}}')" type="button" class="btn btn-danger add-btn" id="create-btn"><i class="ri-delete-bin-line align-bottom me-1"></i> Delete</button>
                                </div>
                            </div>
                        </div>
