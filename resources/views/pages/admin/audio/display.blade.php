                        ...
                        <div class="row g-4 mb-3">
                            <div class="col-sm">
                                <div class="d-flex justify-content-sm-end">
                                    <a href="{{route('audio_edit', $country->id)}}" type="button" class="btn btn-success add-btn me-2" id="create-btn"><i class="ri-edit-line align-bottom me-1"></i> Edit</a>
                                    <button onclick="deleteHandler('{{route('audio_delete', $country->id)}}')" type="button" class="btn btn-danger add-btn" id="create-btn"><i class="ri-delete-bin-line align-bottom me-1"></i> Delete</button>
                                </div>
                            </div>
                        </div>
                        <div class="text-muted">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 col-sm-6">
                                        <div>
                                            ...
                                            <h5 class="fs-15 mb-0">{{$languages[$country->language]}}</h5>
                                        </div>
                                    </div>
                                    <div class="col-lg-3 col-sm-6">
                                        <div>
                            ...
                            <div id="image-container">
                                ...
                                <div class="pt-3 pb-3 border-bottom border-bottom-dashed mt-4">
                                    ...
                                    <img src="{{asset('storage/upload/audios/'.$country->audio)}}" class="mb-3" style="max-width:30%">
                                </div>
                                @endif
                            </div>
