                        ...
                        <div id="customerList">
                            <div class="row g-4 mb-3">
                                ...
                                <div class="col-sm row mt-4" style="justify-content: flex-end">
                                    <form  method="get" action="{{route('audio_view_report')}}" class="col-sm-auto" onsubmit="return callSearchHandler()">
                                    ...
                                    <form  method="get" class="col-sm-auto" action="{{route('audio_view_report')}}" onsubmit="return callSearchHandler()">
                                        <div class="d-flex justify-content-sm-end">
                                            <div class="search-box ms-2">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex gap-2" style="align-items:center">
                                                    ...
                                                    <div class="edit">
                                                        <a href="{{route('audio_display_report', $item->id)}}" class="btn btn-sm btn-info edit-item-btn">View</a>
                                                    </div>
                                                    <div class="edit">
                                                        <a href="{{route('audio_display', $item->AudioModel->id)}}" class="btn btn-sm btn-warning edit-item-btn">Go To Audio</a>
                                                    </div>
                                                    <div class="remove">
                                                        <button class="btn btn-sm btn-danger remove-item-btn" onclick="deleteHandler('{{route('audio_delete_report', $item->id)}}')">Delete</button>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
...
<script>
    function callSearchHandler(){
        ...
        str = arr.join('&');
        window.location.replace('{{route('audio_view_report')}}?'+str)
        return false;
    }
</script>
